python train.py \
     ...
     --ent_desc ./data/def_feature/umls_wiki_id2fea.txt \
     --ent2id_file ./data/def_feature/umls_wiki_cui2id.txt \
     --kg_dict ./fewshot_re_kit/kg_toolkit/wiki_onto --add_cnpt_node \
